package com.sunkitto.news.allNews.adapters
...
import com.sunkitto.news.designSystem.ArticlesUiDiffCallback

class AllNewsAdapter(
    private val listener: AllNewsRecyclerViewClickListener,
) : PagingDataAdapter<ArticleUi, RecyclerView.ViewHolder>(ArticlesUiDiffCallback) {
